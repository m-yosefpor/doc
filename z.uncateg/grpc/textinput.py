...
class SampleTextAssistant(object):
    ...
    def assist(self, text_query):
        ...
        text_response = None
        html_response = None
        for resp in self.assistant.Assist(iter_assist_requests(self.display),
                                          self.deadline):
        ...
        for resp in self.assistant.Assist(iter_assist_requests(False),
                                          self.deadline):
            if resp.dialog_state_out.supplemental_display_text:
                text_response = resp.dialog_state_out.supplemental_display_text
